...
function mayoriaDeEdad(edad) {
  // si la persona según su edad puede ingresar a un evento.
...
function fizzBuzz(numero) {
  ...
  residuo1= numero%3;
  residuo2 = numero%5;
  if (residuo1===0 && residuo2===0) return "fizzbuzz";
    else if (residuo1===0) return "fizz";
         else if (residuo2===0) return "buzz";
               else return numero;
}
...
function esPrimo(numero) {
  ...
  else { //Para cualquier número diferente de 0 y 1
...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
  if (numero>-1000 && numero <-99) return true;  //caso para los números negativos
  else if (numero>99 && numero<1000) return true; 
       else return false;
}
